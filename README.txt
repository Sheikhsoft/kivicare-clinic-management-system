...
### [Telemed Addon](https://codecanyon.net/item/kivicare-telemed-addon/29363726) | [Pro Addon](https://codecanyon.net/item/kivicare-pro-clinic-patient-management-system-ehr-addon/30690654) | [Theme](https://themeforest.net/item/kivicare-medical-clinic-management-theme/29201853) | [Demo](https://iqonic.design/wp-themes/kivicare/wp-login.php) | [Documentation](http://iqonic.design/docs/product/kivicare/getting-started/)
...
### Widget:
For adding appointment widget in your theme use this shortcode;

    [bookAppointment]

For adding patient dashboard widget in your theme use this shortcode;
...
4. Clinic session Detail
5. Dashboard
6. Patient Add
7. Patient List
8. Appointments List
9. Appointments Booking
10. Patient Encounter
11. Invoice
12. Email Templates
13. Clinic Profile
14. Appointment Booking (Widget)
15. Patient Dashboard (Widget)
16. Patient Appointment Booking (Widget)
17. Telemed Appointment Booking  (Widget)
18. Telemed Patient Dashboard (Widget)
19. Telemed Patient Dashboard Join (Widget)
